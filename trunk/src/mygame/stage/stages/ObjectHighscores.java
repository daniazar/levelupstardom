 ...
 * @author matiaspan
 */
public class ObjectHighscores extends GameStage {

    private final UIFrame FRAME;
    UIPanel panel;

    public ObjectHighscores(GameStageEnvironment env) {
	super(env, ObjectHighscores.class.getName());
	...
	panel.setLayout(new UIGridLayout(11, 1));
        ...
        for (Score score : highScores.getHighScore(ScoreType.SCORE_OBJECT)) {
